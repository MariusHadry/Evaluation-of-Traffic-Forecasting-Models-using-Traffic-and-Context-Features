...
from models.nbeatsx.nbeats_model import NBeatsX, NBeatsBlock, IdentityBasis, TrendBasis, SeasonalityBasis
from models.nbeatsx.nbeats_model import ExogenousBasisInterpretable, ExogenousBasisWavenet, ExogenousBasisTCN
from util.nbeatsx.losses import MAPELoss, MASELoss, SMAPELoss, MSELoss, MAELoss, PinballLoss
from util.nbeatsx.metrics import mae, pinball_loss
...
class Nbeats(object):
    ...
    def fit(self, train_ts_loader, val_ts_loader=None, n_iterations=None, verbose=True, eval_steps=1):
        ...
        if not self._is_instantiated:
            ...
            self.model = NBeatsX(t.nn.ModuleList(block_list)).to(self.device)
